...
ee_path = path.expand("/home/seamus/.config/earthengine/seamusrobertmurphy/credentials")
ee_Initialize(user = "seamusrobertmurphy")
...
getGeom <- function(image) {
  rgee::ee$Feature(image$geometry()$centroid(), list(foo = 1))
}
