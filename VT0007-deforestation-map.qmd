...
To improve model performance, we need to first calculate the uncertainty of the classification.
In particular, the following confirms highest uncertainty in wetland and water areas evidently mis-classifed above.
